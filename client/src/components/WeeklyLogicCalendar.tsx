  ...
  return <section className={`weekly-logic-calendar weekly-logic-calendar--${view}`} aria-labelledby="weekly-logic-title">
    <header>
      <div>
        ...
        <p>{filter === "all" ? "Only finished Mini Sudoku, Tango, Queens, Patches, Zip, and Wend edition fields count here." : `Showing completed ${selected.label} daily editions only.`} Game opens, demos, and visual orientation changes never add activity.</p>

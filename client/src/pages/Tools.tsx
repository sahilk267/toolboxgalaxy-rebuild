  ...
  return (
    <AppShell>
      <section className="page-section page-section--tools">
        <div className="tools-hero-runway"><div><div className="page-kicker"><span>01</span><span>VERIFIED TOOL FOUNDRY</span></div><SectionHeading eyebrow="LOCAL-FIRST / ZERO SERVER DEPENDENCIES" title="Small tools. Clear outcomes." copy="The foundry keeps browser-run utilities that can be tested, explained, and used without sending your input away." /></div><aside className="tools-signal-panel" aria-label="Tool foundry status"><div className="tools-signal-panel__head"><img src={orbitMark} alt="" /><span>ORBITAL TOOL CONTROL</span><i>LIVE</i></div><strong>{tools.length} <small>verified modules</small></strong><div className="tools-signal-panel__metrics"><span>LOCAL EXECUTORS <b>{tools.length}/{tools.length}</b></span><span>REMOTE DEPENDENCIES <b>00</b></span><span>INPUT RETENTION <b>NONE</b></span></div></aside></div>
        <FavoriteTools />
        <RecentToolHistory />
